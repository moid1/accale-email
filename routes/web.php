...
Route::group(['middleware' => ['not_installed', 'not_logged_in']], function () {
    ...
    // plan
    Route::get('plans/list/{style?}', 'PlanController@publicListPage');

    // public campaign report
    Route::get('pub/campaigns/job/{uid}/download', 'Pub\CampaignController@download');
    Route::get('pub/campaigns/{uid}/tracking-log/download', 'Pub\CampaignController@trackingLogDownload');
    Route::get('pub/campaigns/job/{uid}/progress', 'Pub\CampaignController@trackingLogExportProgress');
    Route::get('pub/campaigns/{uid}/tracking-log/download', 'Pub\CampaignController@trackingLogDownload');
    Route::get('pub/campaigns/{uid}/overview', 'Pub\CampaignController@overview');
    Route::get('pub/campaigns/{uid}/subscribers', 'Pub\CampaignController@subscribers');
    Route::get('pub/campaigns/{uid}/subscribers/listing', 'Pub\CampaignController@subscribersListing');
    Route::get('pub/campaigns/{uid}/open-map', 'Pub\CampaignController@openMap');
    Route::get('pub/campaigns/{uid}/tracking-log', 'Pub\CampaignController@trackingLog');
    Route::get('pub/campaigns/{uid}/tracking-log/listing', 'Pub\CampaignController@trackingLogListing');
    Route::get('pub/campaigns/{uid}/bounce-log', 'Pub\CampaignController@bounceLog');
    Route::get('pub/campaigns/{uid}/bounce-log/listing', 'Pub\CampaignController@bounceLogListing');
    Route::get('pub/campaigns/{uid}/feedback-log', 'Pub\CampaignController@feedbackLog');
    Route::get('pub/campaigns/{uid}/feedback-log/listing', 'Pub\CampaignController@feedbackLogListing');
    Route::get('pub/campaigns/{uid}/open-log', 'Pub\CampaignController@openLog');
    Route::get('pub/campaigns/{uid}/open-log/listing', 'Pub\CampaignController@openLogListing');
    Route::get('pub/campaigns/{uid}/click-log', 'Pub\CampaignController@clickLog');
    Route::get('pub/campaigns/{uid}/click-log/listing', 'Pub\CampaignController@clickLogListing');
    Route::get('pub/campaigns/{uid}/unsubscribe-log', 'Pub\CampaignController@unsubscribeLog');
    Route::get('pub/campaigns/{uid}/unsubscribe-log/listing', 'Pub\CampaignController@unsubscribeLogListing');

    Route::get('pub/campaigns/quick-view', 'Pub\CampaignController@quickView');
    Route::get('pub/campaigns/{uid}/chart24h', 'Pub\CampaignController@chart24h');
    Route::get('pub/campaigns/{uid}/chart', 'Pub\CampaignController@chart');
    Route::get('pub/campaigns/{uid}/chart/countries/open', 'Pub\CampaignController@chartCountry');
    Route::get('pub/campaigns/{uid}/chart/countries/click', 'Pub\CampaignController@chartClickCountry');
    Route::get('pub/campaigns/{uid}/overview', 'Pub\CampaignController@overview');
    Route::get('pub/campaigns/{uid}/links', 'Pub\CampaignController@links');

    Route::get('pub/campaigns/{uid}/preview/content/{subscriber_uid?}', 'Pub\CampaignController@previewContent');
    Route::get('pub/campaigns/{uid}/preview', 'Pub\CampaignController@preview');
});
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend']], function () {
    ...
    Route::get('account/subscription/order-box/{invoice_uid}', 'SubscriptionController@orderBox');
    ...
    Route::post('account/subscription/checkout/{invoice_uid}', 'SubscriptionController@checkout');
    ...
    Route::post('account/subscription/recurring/enable', 'SubscriptionController@enableRecurring');
    Route::post('account/subscription/recurring/disable', 'SubscriptionController@disableRecurring');
    Route::get('account/subscription/payment/{invoice_uid}', 'SubscriptionController@payment');
    Route::post('account/subscription/assign-plan', 'SubscriptionController@assignPlan');
    Route::post('account/subscription/select-plan', 'SubscriptionController@selectPlan');
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend', 'subscription']], function () {
    ...
    // Subscriber
    Route::get('lists/{list_uid}/subscribers/import2/progress/content', 'SubscriberController@import2ProgressContent');
    Route::get('lists/{list_uid}/subscribers/import2/progress', 'SubscriberController@import2Progress');
    Route::post('lists/{list_uid}/subscribers/import2/run', 'SubscriberController@import2Run');
    Route::post('lists/{list_uid}/subscribers/import2/validate', 'SubscriberController@import2Validate');
    Route::get('lists/{list_uid}/subscribers/import2/mapping', 'SubscriberController@import2Mapping');
    Route::post('lists/{list_uid}/subscribers/import2/upload', 'SubscriberController@import2Upload');
    Route::get('lists/{list_uid}/subscribers/import2/wizard', 'SubscriberController@import2Wizard');
    Route::get('lists/{list_uid}/subscribers/import2', 'SubscriberController@import2');
    Route::get('subscribers/no-list', 'SubscriberController@noList');
    ...
    // Segment
    Route::get('segments/no-list', 'SegmentController@noList');
    ...
    // Template
    Route::get('templates/chat', 'TemplateController@chat');
    ...
    // Campaign
    Route::post('campaigns/{uid}/preheader/remove', 'CampaignController@preheaderRemove');
    Route::match(['get', 'post'], 'campaigns/{uid}/preheader/add', 'CampaignController@preheaderAdd');
    Route::get('campaigns/{uid}/preheader', 'CampaignController@preheader');
    ...
    Route::get('tracking_domains/{uid}/cname', 'TrackingDomainController@showCname');
    Route::get('tracking_domains/{uid}/verify/cname', 'TrackingDomainController@verifyCname');
    ...
    // Automation2
    Route::match(['get', 'post'], 'automation/{uid}/copy', 'Automation2Controller@copy');
    Route::get('automation/{uid}/condition/remove', 'Automation2Controller@conditionRemove');

    Route::post('automation/{uid}/template/{email_uid}/preheader/remove', 'Automation2Controller@emailPreheaderRemove');
    Route::match(['get', 'post'], 'automation/{uid}/template/{email_uid}/preheader/add', 'Automation2Controller@emailPreheaderAdd');
    Route::get('automation/{uid}/template/{email_uid}/preheader', 'Automation2Controller@emailPreheader');
    ...
    Route::post('automation/disable', 'Automation2Controller@disable');
    Route::post('automation/enable', 'Automation2Controller@enable');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['not_installed', 'auth', 'backend']], function () {
    ...
    // Template
    Route::get('admin/templates/chat', 'TemplateController@chat');
    ...
    // Customer
    Route::get('admin/customers/{uid}/one-click-login', 'CustomerController@oneClickLogin');
    ...
    // Admin
    Route::get('admin/admins/{uid}/one-click-login', 'AdminController@oneClickLogin');
    ...
    // Plan
    Route::match(['get', 'post'], 'admin/plans/public-view/{style?}', 'PlanController@publicView');
    ...
    // Subscription
    Route::post('admin/subscriptions/{id}/replenish-sending-credits', 'SubscriptionController@replenishSendingCredits');
    ...
    Route::post('admin/subscriptions/{id}/recurring/enable', 'SubscriptionController@enableRecurring');
    Route::post('admin/subscriptions/{id}/recurring/disable', 'SubscriptionController@disableRecurring');
    ...
    // Email verification servers
    Route::post('admin/subscriptions/{id}/terminate', 'SubscriptionController@terminate');
    ...
    Route::match(['get', 'post'], 'admin/plugins/{uid}/delete', 'PluginController@delete');
    Route::get('admin/plugins/disable', 'PluginController@disable');
    Route::get('admin/plugins/enable', 'PluginController@enable');
    Route::get('admin/plugins/reindex', 'PluginController@reindex');
    ...
    // Chat
    Route::post('admin/chat', 'ChatController@chat');
});
