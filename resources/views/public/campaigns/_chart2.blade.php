        ...
        <div class="col-md-5">
            <p class="d-flex align-items-center mb-2">
                ...
                <span class="text-semibold">
                    ...
                    ]) }} <strong> · </strong> {{ $campaign->customer->formatDateTime($campaign->run_at, 'datetime_full') }}
                </span>
            </p>
            ...
            <a href="{{ action('Pub\CampaignController@resend', ["uid" => $campaign->uid]) }}" class="btn btn-secondary resend-campaign">{{ trans("messages.campaign.resend") }}</a>
        </div>
    </div>
</div>
-->