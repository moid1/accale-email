...
class TemplateController extends Controller
{
    ...
    public function listing(Request $request)
    {
        if ($request->from == 'mine') {
            $templates = $request->user()->customer->templates()->notPreserved()->email();
    ...
    public function builderEdit(Request $request, $uid)
    {
        ...
        return view('templates.builder.edit', [
            'template' => $template,
            'templates' => $user->customer->getBuilderTemplates(),
    ...
    public function builderTemplates(Request $request)
    {
        ...
        // sort, pagination
        $templates = $category->templates()->shared()->notPreserved()->email()->search($request->keyword)
            ->orderBy($request->sort_order, $request->sort_direction)
